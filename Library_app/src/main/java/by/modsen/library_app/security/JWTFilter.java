...
public class JWTFilter extends OncePerRequestFilter {
    ...
    @Autowired
    public JWTFilter(LibraryUsersDetailsService libraryUsersDetailsService, JWTUtil jwtUtil) {
        ...
        if (authHeader != null && !authHeader.isBlank() && authHeader.startsWith("Bearer ")) {
            ...
            if (jwt.isBlank()) {
                ...
                try {
                    ...
                    UserDetails userDetails = libraryUsersDetailsService.loadUserByUsername(username);
